...
function App() {
  ...
  // Initialize devices from localStorage or use default
  const [devices, setDevices] = useState(() => {
    const savedDevices = localStorage.getItem('app_devices');
    if (savedDevices) {
      try {
  ...
  // Persist devices to localStorage whenever it changes
  useEffect(() => {
