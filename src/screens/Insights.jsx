            ...
            <div className="content">
                ...
                <div style={{
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: 'var(--bg-icon-blue)', padding: '0.5rem', borderRadius: '50%' }}>
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: 'var(--bg-icon-red)', padding: '0.5rem', borderRadius: '50%' }}>
                                <Thermometer size={20} color="var(--text-accent)" />
                            </div>
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: 'var(--bg-icon-yellow)', padding: '0.5rem', borderRadius: '50%' }}>
                                <Lightbulb size={20} color="var(--text-accent)" />
                            </div>
                ...
                <div className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '1rem' }}>
                    <div style={{ position: 'relative' }}>
                        <Sun size={32} color="var(--text-accent)" />
                        <div style={{ position: 'absolute', bottom: -5, right: -5, background: 'var(--bg-icon-blue)', borderRadius: '50%', padding: '2px' }}>
                            <Battery size={12} color="var(--text-accent)" />
                        </div>
                    </div>
                    <div style={{ flex: 1 }}>
