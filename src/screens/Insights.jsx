...
const Insights = ({ devices, settings }) => {
    ...
    const estBill = Math.round(totalLoadDaily * 30 * (settings?.electricityRate || 0.15));
                ...
                <div className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '1rem' }}>
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '0.25rem' }}>
                            Your Ideal Solar Setup: {settings?.systemSize || 5}kW System + {(settings?.systemSize || 5) * 2}kWh Battery. Invest for lifetime savings.
                        </div>
