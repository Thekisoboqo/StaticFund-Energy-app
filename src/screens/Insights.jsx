...
const Insights = ({ devices }) => {
    ...
    const estBill = 150 + totalLoad * 0; // Hardcoded for demo match + suppress unused var
            ...
            <div className="content">
                ...
                <div style={{
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        <div style={{ marginTop: 'auto', background: 'var(--bg-mint)', color: 'var(--accent)', border: '1px solid var(--accent)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 600, textAlign: 'center' }}>
                            Save ~$20/mo
                        </div>
                    </div>
