    ...
    return (
        <div>
            ...
            <div className="content">
                ...
                {/* Insights Summary */}
                <div className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '1rem', background: 'var(--bg-blue)' }}>
                    <div style={{ flex: 1, textAlign: 'center' }}>
                        <div style={{ fontWeight: 700, fontSize: '0.875rem' }}>Total Load Profile</div>
                        <div style={{ fontSize: '1.25rem', color: 'var(--accent)', marginTop: '0.25rem', fontWeight: 800 }}>
                            {totalLoad.toFixed(2)} kWh / day
                        </div>
                    </div>
                </div>
