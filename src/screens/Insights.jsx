...
const Insights = ({ devices }) => {
    ...
    const dailyLoadKWh = devices.reduce((acc, device) => acc + (device.watts * (device.hours || 0)), 0) / 1000;
    // Assume roughly $0.20 per kWh and 30 days a month
    const estBill = Math.round(dailyLoadKWh * 0.20 * 30);
            ...
            <div className="content">
                ...
                <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0', position: 'relative' }}>
                    <div style={{
                        ...
                        height: '200px',
                        borderRadius: '50%',
                        background: 'conic-gradient(#F59E0B 0% 35%, var(--accent) 35% 65%, #38BDF8 65% 100%)',
                        display: 'flex',
                        alignItems: 'center',
