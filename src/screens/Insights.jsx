...
const Insights = () => {
    ...
    return (
        <div>
            <div className="header" style={{ padding: '0 0 0.5rem 0' }}>Your Personal Energy Plan</div>
            <div className="sub-header" style={{ padding: '0 0 1rem 0' }}>Actionable steps to save money.</div>
