...
const Insights = ({ devices }) => {
    ...
    const estBill = (totalLoad * 0.15 * 30).toFixed(2); // Simple mock calculation (Monthly)
                ...
                <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0', position: 'relative' }}>
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: '0.6rem', color: 'var(--text-secondary)', marginTop: '0.25rem' }}>Load: {totalLoad.toFixed(1)} kWh/day</div>
                        </div>
                    </div>
