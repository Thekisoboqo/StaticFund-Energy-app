...
const Insights = ({ devices, electricityRate }) => {
    // Calculate actual estimated monthly bill
    const dailyKWh = devices.reduce((acc, device) => acc + ((device.watts * (device.hours || 0)) / 1000), 0);
    const monthlyKWh = dailyKWh * 30;
    const estBill = (monthlyKWh * electricityRate).toFixed(2);
            ...
            <div className="content">
                ...
                <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0', position: 'relative' }}>
                    <div style={{
                        ...
                        height: '200px',
                        borderRadius: '50%',
                        background: 'conic-gradient(var(--accent) 0% 35%, #34D399 35% 65%, #059669 65% 100%)',
                        display: 'flex',
                        alignItems: 'center',
                    ...
                    <div style={{ position: 'absolute', top: '10%', right: '-10px', textAlign: 'left' }}>
                        ...
                        <div style={{ fontWeight: 700, color: 'var(--accent)' }}>35%</div>
                    </div>
                    <div style={{ position: 'absolute', bottom: '20%', right: '-10px', textAlign: 'left' }}>
                        <div style={{ fontWeight: 600 }}>Cooling</div>
                        <div style={{ fontWeight: 700, color: '#34D399' }}>30%</div>
                    </div>
                    <div style={{ position: 'absolute', top: '40%', left: '-10px', textAlign: 'right' }}>
                        <div style={{ fontWeight: 600 }}>Other</div>
                        <div style={{ fontWeight: 700, color: '#059669' }}>35%</div>
                    </div>
                </div>
