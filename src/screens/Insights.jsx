...
const Insights = ({ devices }) => {
    ...
    return (
        <div>
            ...
            <div className="sub-header">Actionable steps to save money. Total Daily Load: {totalLoad.toFixed(2)} kWh.</div>
            ...
            <div className="content">
                ...
                <div className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '1rem' }}>
                    <div style={{ position: 'relative' }}>
                        ...
                        <div style={{ position: 'absolute', bottom: -5, right: -5, background: 'var(--text-brand)', borderRadius: '50%', padding: '2px' }}>
