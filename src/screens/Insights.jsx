...
const Insights = ({ devices }) => {
    ...
    return (
        <div>
            <div className="header">Your Personal Energy Plan ({totalLoad.toFixed(1)} kWh/day)</div>
            ...
            <div className="content">
                ...
                <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0', position: 'relative' }}>
                    <div style={{
                        ...
                        height: '200px',
                        borderRadius: '50%',
                        background: 'conic-gradient(var(--color-yellow-bg) 0% 35%, var(--color-green-bg) 35% 65%, var(--color-blue-bg) 65% 100%)',
                        display: 'flex',
                        alignItems: 'center',
                ...
                <div style={{
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: 'var(--color-blue-bg)', padding: '0.5rem', borderRadius: '50%' }}>
                                <Clock size={20} color="var(--color-blue-icon)" />
                            </div>
                        ...
                        <div style={{ marginTop: 'auto', background: 'var(--color-green-bg)', color: 'var(--color-green-text)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 600, textAlign: 'center' }}>
                            Save ~$20/mo
                        </div>
                    </div>
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: 'var(--color-red-bg)', padding: '0.5rem', borderRadius: '50%' }}>
                                <Thermometer size={20} color="var(--color-red-icon)" />
                            </div>
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: 'var(--color-yellow-bg)', padding: '0.5rem', borderRadius: '50%' }}>
                                <Lightbulb size={20} color="var(--color-yellow-icon)" />
                            </div>
                ...
                <div className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '1rem' }}>
                    <div style={{ position: 'relative' }}>
                        <Sun size={32} color="var(--color-sun)" />
