            ...
            <div className="content">
                ...
                <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0', position: 'relative' }}>
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginBottom: '0.25rem' }}>Daily<br />Load:</div>
                            <div style={{ fontSize: '1.5rem', fontWeight: 800 }}>{totalLoad.toFixed(1)} kWh</div>
                            <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '0.25rem' }}>Est. ${estBill}/mo</div>
                        </div>
                    </div>
                ...
                <div className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '1rem' }}>
                    <div style={{ position: 'relative' }}>
                        ...
                        <div style={{ position: 'absolute', bottom: -5, right: -5, background: 'var(--accent-hover)', borderRadius: '50%', padding: '2px' }}>
