...
const Insights = ({ devices, settings }) => {
    ...
    const dailyKwh = devices.reduce((acc, device) => acc + (device.watts * (device.hours || 0)), 0) / 1000;

    // Estimate monthly bill (30 days) based on settings electricity rate
    const estBill = Math.round(dailyKwh * 30 * (settings?.electricityRate || 0.15));
            ...
            <div className="content">
                ...
                <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0', position: 'relative' }}>
                    <div style={{
                        ...
                        height: '200px',
                        borderRadius: '50%',
                        background: 'conic-gradient(#FBBF24 0% 35%, #0CD3AD 35% 65%, #38BDF8 65% 100%)',
                        display: 'flex',
                        alignItems: 'center',
                ...
                <div style={{
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: '#1A2A33', padding: '0.5rem', borderRadius: '50%' }}>
                        ...
                        <div style={{ marginTop: 'auto', background: 'rgba(12, 211, 173, 0.1)', color: 'var(--accent)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 600, textAlign: 'center' }}>
                            Save ~$20/mo
                        </div>
                    </div>
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: '#2C1A1A', padding: '0.5rem', borderRadius: '50%' }}>
