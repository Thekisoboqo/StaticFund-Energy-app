...
const Insights = ({ devices }) => {
    const [electricityRate] = useState(() => {
        try {
            ...
            console.error('Error parsing electricityRate', e);
            return 0.15;
        }
    });
    ...
    const [inverterConfig] = useState(() => {
        try {
            ...
            console.error('Error parsing inverterConfig', e);
                ...
                <div className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '1rem' }}>
                    ...
                    <div style={{ flex: 1 }}>
                        ...
                        <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '0.25rem' }}>
                            Your Ideal Solar Setup: {inverterConfig.systemSize}kW System + {inverterConfig.batterySize}kWh Battery. Invest for lifetime savings.
                        </div>
