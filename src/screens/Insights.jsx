            ...
            <div className="content">
                ...
                <div style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0', position: 'relative' }}>
                    <div style={{
                        ...
                        height: '200px',
                        borderRadius: '50%',
                        background: 'conic-gradient(var(--accent) 0% 35%, var(--border) 35% 65%, var(--bg-blue) 65% 100%)',
                        display: 'flex',
                        alignItems: 'center',
                        ...
                        <div style={{
                            ...
                            <div style={{ fontSize: '0.75rem', color: 'var(--text-secondary)', marginTop: '0.25rem' }}>Total Load:<br />{totalLoad.toFixed(2)} kWh</div>
                        </div>
                    </div>
