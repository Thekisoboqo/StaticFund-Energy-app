            ...
            <div className="content">
                ...
                <div style={{
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        ...
                        <div style={{ marginTop: 'auto', background: 'var(--bg-mint)', color: 'var(--text-primary)', padding: '0.25rem 0.5rem', borderRadius: '4px', fontSize: '0.75rem', fontWeight: 600, textAlign: 'center', border: '1px solid var(--border)' }}>
                            Save ~$20/mo
                        </div>
                    </div>
                ...
                <div className="card" style={{ display: 'flex', gap: '1rem', alignItems: 'center', marginTop: '1rem' }}>
                    <div style={{ position: 'relative' }}>
                        ...
                        <div style={{ position: 'absolute', bottom: -5, right: -5, background: 'var(--bg-mint)', borderRadius: '50%', padding: '2px', border: '1px solid var(--border)' }}>
