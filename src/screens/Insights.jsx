...
const Insights = ({ devices }) => {
    // Total load can be used for calculations, or just keeping standard demo values
    const estBill = devices.length > 0 ? 150 : 0; // Keeping logic simple to clear warning
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <div className="content" style={{ padding: '0 1.5rem 80px 1.5rem' }}>
                {/* Donut Chart Section */}
                ...
                <div style={{
                    ...
                    <div className="card" style={{ minWidth: '160px', flex: '0 0 auto', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <div style={{ background: '#451A1A', padding: '0.5rem', borderRadius: '50%' }}>
