...
import { loadRateRPerKwh, RATE_STORAGE_KEY, DEFAULT_RATE_R_PER_KWH } from '../utils/constants';
...
const Settings = () => {
  ...
  const commitRate = (raw) => {
    ...
    window.dispatchEvent(new StorageEvent('storage', { key: RATE_STORAGE_KEY, newValue: stringified }));
