        ...
        <div>
            ...
            <div style={{ padding: '0 1.5rem 1.5rem' }}>
                ...
                {!isAdding ? (
                    ...
                    >
                        {/* Decorative circle */}
                        <div style={{ position: 'absolute', top: '-20px', right: '-20px', width: '100px', height: '100px', borderRadius: '50%', background: 'rgba(56, 189, 248, 0.1)' }} />

                        <div style={{ background: 'rgba(56, 189, 248, 0.2)', padding: '1rem', borderRadius: '50%', marginBottom: '1rem' }}>
            ...
            <div style={{
                position: 'sticky',
                bottom: -20, // Offset the padding we added to Layout content
