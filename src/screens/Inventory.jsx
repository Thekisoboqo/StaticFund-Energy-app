...
const Inventory = ({ devices, onAdd, onRemove }) => {
    ...
    return (
        <div>
            ...
            <div style={{
                position: 'sticky',
                bottom: -20, // Adjust bottom to avoid overlap
                backgroundColor: 'var(--bg-card)',
                padding: '1.5rem',
                borderTop: '1px solid var(--border)',
                borderRadius: 'var(--radius-lg) var(--radius-lg) 0 0',
                boxShadow: '0 -4px 6px -1px rgb(0 0 0 / 0.3)',
                margin: '0 -1.5rem -1.5rem -1.5rem', // Bleed out to edges
            }}>
                ...
                <div style={{ width: '100%', height: '8px', backgroundColor: '#1F3330', borderRadius: '4px', overflow: 'hidden' }}>
