            ...
            <div style={{ padding: '0 1.5rem 1.5rem' }}>
                ...
                {!isAdding ? (
                    ...
                    >
                        ...
                        <div style={{ background: 'var(--bg-mint)', padding: '1rem', borderRadius: '50%', marginBottom: '1rem', zIndex: 1 }}>
                            <Camera size={32} color="var(--accent)" />
                        </div>
                        <span style={{ fontWeight: 600, fontSize: '1.125rem', zIndex: 1 }}>Scan a new appliance</span>
                    </div>
                ) : (
