        ...
        <div>
            ...
            <div style={{ padding: '0 1.5rem 1.5rem' }}>
                ...
                {!isAdding ? (
                    ...
                    >
                        {/* Decorative circle */}
                        <div style={{ position: 'absolute', top: '-20px', right: '-20px', width: '100px', height: '100px', borderRadius: '50%', background: 'var(--bg-card)', opacity: 0.5 }} />

                        <div style={{ background: 'var(--bg-primary)', padding: '1rem', borderRadius: '50%', marginBottom: '1rem' }}>
