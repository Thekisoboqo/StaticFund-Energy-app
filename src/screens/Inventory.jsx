...
import { Camera, ChevronRight, Refrigerator, Tv, Zap } from 'lucide-react';
        ...
        <>
            ...
            <div className="content">
                ...
                {!isAdding ? (
                    ...
                    >
                        {/* Decorative circle */}
                        <div style={{ position: 'absolute', top: '-20px', right: '-20px', width: '100px', height: '100px', borderRadius: '50%', background: 'var(--border)', opacity: 0.5 }} />

                        <div style={{ background: 'var(--bg-mint)', padding: '1rem', borderRadius: '50%', marginBottom: '1rem' }}>
                            <Camera size={32} color="var(--accent)" />
                        </div>
                        <span style={{ fontWeight: 600, fontSize: '1.125rem', color: 'var(--accent)' }}>Scan a new appliance</span>
                    </div>
                ) : (
